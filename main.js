...
function test_func(){
	game.players.push(new Player(new Point(50 ,canvas.height - 60), 380, 100, new Point(40, 60), resources.sprites.get("ship")));
	...
	game.ents.push(new DefaultEnemy([new Point(200, 150), new Point(800, 150), new Point(800, 600), new Point(200, 600)], new Point(0, 0), 250, 5, new Point(90, 90), resources.sprites.get("enemy_1")));
