...
function test_func(){
	...
	game.ents.push(new DefaultEnemy([new Point(200, 150), new Point(800, 150), new Point(800, 600), new Point(200, 600)], new Point(0, 0), 250, 5, new Point(40, 60), resources.sprites.get("ship")));
